            ...
            <div id="container">
                ...
                <div  id="container2">
                   ...
                   <?php
                        ...
                        $query = "SELECT id,postingan.NIM,postingan,judul,tanggal,gambar,mahasiswa.Nama 
                                                    FROM postingan
                                                    INNER JOIN mahasiswa
                                                    USING(NIM) ORDER BY id DESC";
                        ...
                        $query2 = "SELECT id,postingan.NIM,postingan,judul,tanggal,gambar,mahasiswa.Nama 
                                                    FROM postingan
                                                    INNER JOIN mahasiswa
                                                    USING(NIM) ORDER BY id DESC LIMIT $mulai, $batas";
                    ...
                    ?>
                                    <tr style="border: solid thin #666">
                                            <td style="border: solid thin #666"><?php echo $row['Nama']; ?></td>
